...
$jscomp.findInternal = function (a, e, f) {
  ...
  for (var g = a.length, b = 0; b < g; b++) {
    var m = a[b];
    if (e.call(f, m, b, a)) return { i: b, v: m };
  }
  return { i: -1, v: void 0 };
};
$jscomp.ASSUME_ES5 = !1;
...
$jscomp.polyfill(
  ...
  function (a) {
    ...
    b.prototype.resolveToNonPromiseObj_ = function (a) {
      ...
      "function" == typeof c
        ? this.settleSameAsThenable_(c, a)
        : this.fulfill_(a);
    };
      ...
      return d.done
        ...
        : new b(function (a, b) {
            ...
            do
              h.push(void 0),
                l++,
                f(d.value).callWhenSettled_(e(h.length - 1), b),
                (d = c.next());
            while (!d.done);
          });
    };
  ...
  "function" == typeof Object.assign
    ...
    : function (a, e) {
        for (var f = 1; f < arguments.length; f++) {
          var g = arguments[f];
          if (g) for (var b in g) $jscomp.owns(g, b) && (a[b] = g[b]);
        }
        return a;
      };
$jscomp.polyfill(
...
~(function () {
  ...
  function e(a, b, c) {
    ...
    -1 !== e &&
      b &&
      !d[e].intervalId &&
      (d[e].intervalId = setInterval(function () {
        if (!document.hidden) {
          var b = d.findIndex(function (b) {
            return b.carouselId === a;
          });
          -1 !== b &&
            (1 !== d[b].embla.scrollProgress()
              ? d[b].embla.scrollNext()
  ...
  function f(b, c) {
    return new Promise(function (e, h) {
      ...
      if (
        ...
        l.on("select", q);
        l.on("init", q);
        d.push({ carouselId: g, embla: l, intervalId: null });
        e(l);
      }
    });
  }
  ...
  function b(a) {
    ...
    -1 !== b &&
      ("embla" in d[b] && d[b].embla.destroy(),
      clearInterval(d[b].intervalId),
      d.splice(b, 1));
  }
  function m(a) {
    return "true" === a ? !0 : a;
  ...
  u && (r = jQuery);
  if (document.querySelector("html").classList.contains("is-builder") && u)
    r(document)
    ...
    "undefined" === typeof window.initCarouseMultiplePlugin &&
      ((window.initCarouseMultiplePlugin = !0),
      document.querySelectorAll(".mbr-embla").forEach(function (a) {
